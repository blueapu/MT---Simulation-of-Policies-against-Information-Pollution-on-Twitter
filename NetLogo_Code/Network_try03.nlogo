...
[
  ...
  suscept           ;; susceptibility to tweets
...
to setup-nodes
  ...
  ask turtles [ set suscept random 4 ]
...
to setup-ads
  ask n-of number-of-redads turtles with [ polview > 6 ]  [
    set color red
  ]
  ask n-of number-of-blueads turtles with [ polview < 3 ] [
    set color blue
  ]
end
...
to change-polview
  ask turtles [
    if viewred > viewblue [ set polview polview + 1 ]
