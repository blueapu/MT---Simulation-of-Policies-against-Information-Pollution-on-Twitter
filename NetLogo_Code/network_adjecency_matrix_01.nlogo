...
to setup
  set-current-directory "D:\\Studium\\MT_MasterThesis\\MT_Code\\NetLogo_Code" ; setting working-directory
  clear-all
  set-default-shape turtles "circle"

  nw:load-matrix "Data\\test_matrix_01.txt" turtles links ; loading adjacency matrix
