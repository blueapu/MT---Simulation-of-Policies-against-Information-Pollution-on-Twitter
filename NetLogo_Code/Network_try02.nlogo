turtles-own
[
  polview           ;; political view
  viewred           ;; viewed "red"
  sentred           ;; sent "red"
  viewblue          ;; viewed "blue"
  sentblue          ;; sent "blue"
  suscept           ;; elasticity of political view on
]
...
; view of ads from "red" and "blue" of linked neighbors
to view-ad
  ask turtles [
    set viewred sum [sentred] of other turtles with [link-neighbor? myself]
    set viewblue sum [sentblue] of other turtles with [link-neighbor? myself]
    ;;; count "sentblue" ande "sentred" messages of linked neighbors
    ;;; and put it into viewred and viewblue
  ]
end

; change of policital view, based on "red" and "blue" ads
to change-polview
  ask turtles [
    if (viewred / viewblue) > 0.6 [
    set polview polview + 0.1
    ]
  ;;; change degree of "polview", based on "viewblue" and "viewred" and "suscept"
  ]
end

; decision to send ads, based on "polview"
to send-ad
  if polview < 3 [
    set sentred viewred
    set sentblue 0
