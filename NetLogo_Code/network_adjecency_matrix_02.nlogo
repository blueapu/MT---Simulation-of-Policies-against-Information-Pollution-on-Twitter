...
; setting-up
to setup
  set-current-directory "C:\\Users\\blueapu\\Desktop\\MT_MasterThesis\\MT_Code\\NetLogo_Code" ; setting working-directory
  clear-all
...
; defining actions (global)
to go
  tweet_reading
  tweet_action
end

; defining actions (local)
to tweet_reading
  ask patches [
    if random 100 < regrow-rate [set pcolor green ]
  ]
end
