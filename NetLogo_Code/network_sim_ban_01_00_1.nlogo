...
to account_ban
  ...
  if ticks = one-of [345 164 232 272  27 149 216 137  10 233 271  49 242 354 275 289  45   2 107 100  33 349 226 325 265  95 352 281 113 273 308 282 254  44 108  76 309 222 120
306 157 341 245 126 186 156 357 112  94 189 148  86 315 143   1 154 351 330 102 101   4 237 194 301 251 132 365 170 339  41  20  61 174 175 139 198 340  28
29  26 229 307 363 220 187  13 280 247 121 317 205 ]
  [
...
;to account_ban
;  if ticks = 3 or ticks = 20  or ticks = 40  or ticks = 60  or ticks = 80  or ticks = 100  or ticks = 120  or ticks = 240  or ticks = 260  or ticks = 300 [
;    ask one-of turtles with [post_ip_twt = 1 and twt_type = "SUP"] [ die ]
;  ]
;end
