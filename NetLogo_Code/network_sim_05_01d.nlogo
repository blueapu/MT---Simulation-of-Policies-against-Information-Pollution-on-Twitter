...
to readin-prob
 ...
 if model_version = "large"
  [
    ...
    [
    user-message "There is no file called prob_input_large.txt in directory Data!" ; message, when no file "prob_input_large.txt" present ("else"-condition of first "ifelse")
    ]
  ]
